...
public class GamblingSimulatorUC6 {
    ...
    public static void main(String[] args) {
        ...
        for (int day = 1; day <= 20; day++) {
            ...
            if(cashOfPlayer == 150) {
                System.out.println("Day" + day + " is Player's Luckiest day the cash of the player is " + cashOfPlayer + " $");
            }
            else if(cashOfPlayer == 50) {
                System.out.println("Day" + day + " is Player's Unlukiest day the cash of the player is " + cashOfPlayer + " $");
            }
        }
